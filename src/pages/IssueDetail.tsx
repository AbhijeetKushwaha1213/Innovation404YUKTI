        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Priority Badge */}
              <Badge className={`${getPriorityLevel(upvoteCount).color} border flex items-center gap-1.5`}>
                <span className={`w-2 h-2 rounded-full ${getPriorityLevel(upvoteCount).dotColor}`}></span>
                {getPriorityLevel(upvoteCount).label}
              </Badge>
            </div>
          </div>
