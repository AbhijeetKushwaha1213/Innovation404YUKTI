  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (imageFiles.length > 0) {
        ...
        console.log('Image converted for duplicate check');
      }
      ...
      console.log('Confidence:', duplicateCheck.confidence);
      console.log('Number of duplicates found:', duplicateCheck.duplicates.length);
